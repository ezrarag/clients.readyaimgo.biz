...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex min-h-12 items-center justify-center rounded-full border border-border/70 bg-white/80 p-1 text-muted-foreground shadow-sm backdrop-blur-sm",
      className
    )}
    {...props}
  />
