...
function LoginPageContent() {
  ...
  return (
    <AuthShell
      title="Sign in"
      description="Use your Readyaimgo workspace account."
      asideTitle="Welcome back."
      asideDescription="Access your projects, shared files, payments, and team notes from one focused workspace."
      highlights={[
        "Projects, files, and notes stay attached to your account",
        "Google sign-in is the fastest path back to your workspace",
      ]}
      footer={
    ...
    >
      ...
      <div className="relative">
        ...
        <div className="relative flex justify-center text-xs uppercase tracking-[0.28em]">
          <span className="bg-card px-4 text-slate-500">or use email</span>
        </div>
      </div>
